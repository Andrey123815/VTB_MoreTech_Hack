...
export class init1665264934536 implements MigrationInterface {
  name = 'init1665264934536';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users_tasks" ("id" character varying NOT NULL, "userId" integer NOT NULL, "taskId" integer NOT NULL, "rewardFeature" double precision NOT NULL, "completionStatus" "public"."users_tasks_completionstatus_enum" NOT NULL DEFAULT 'in_progress', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "doneAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ee7aa71bbf9ca313147a17b4fea" PRIMARY KEY ("id", "userId", "taskId"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tasks_creationstatus_enum" AS ENUM('created', 'in_moderation', 'rejected')`,
    );
    await queryRunner.query(
      `CREATE TABLE "tasks" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "rewardCoins" integer NOT NULL, "featureId" integer NOT NULL, "creationStatus" "public"."tasks_creationstatus_enum" NOT NULL DEFAULT 'in_moderation', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "creatorId" integer, CONSTRAINT "UQ_067be4bd67747aa64451933929e" UNIQUE ("title"), CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" ADD CONSTRAINT "FK_52bc9b2512a147a542513032fd3" FOREIGN KEY ("featureId") REFERENCES "features"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tasks" DROP CONSTRAINT "FK_52bc9b2512a147a542513032fd3"`,
    );
    await queryRunner.query(
